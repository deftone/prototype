...
/**
 * from tutorial https://o7planning.org/en/10487/android-mediaplayer-and-videoview-tutorial#a1247679
 */
public class VideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String videoName = getIntent().getExtras().getString(EXTRA_EXERCISE_NAME);
